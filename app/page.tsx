      ...
      <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
        <div className='text-center mb-4'>
          <div className='flex justify-center items-center'>
            ...
            <h1 className='inline-block animate-move-to-center2 transform translate-x-full  text-white-500 border boder-black leading-none tracking-tight m-0 p-0'>I</h1>
          </div>
